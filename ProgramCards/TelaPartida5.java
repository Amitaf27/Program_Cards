...
public class TelaPartida5 extends JFrame { 
     ...
     bt4.addActionListener(  
          ...
          opcao.add(voltar);          
              ...
              perg = new JLabel("Desejo utilizar uma estrutura de repeticao, qual estrutura devo usar?"); 
              perg.setFont(fonte1); 
     ...
     public static void main (String[]args){ 
        TelaPartida5 ex = new TelaPartida5(); 
